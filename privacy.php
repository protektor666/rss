...
<html lang="en">
<head>
    <title>Privacy Policy | fivefilters.org</title>
	<meta name="description" content="FiveFilters.org privacy policy">
...
<body>
	...
	<div class="banner-container">
		<div class="container">
			<div class="row">
				<div class="span8 clearfix header-contents">
	...
	<article class="container regular-section">
		<div class="row">
			<div class="span6">
			
				<p>This privacy policy sets out how FiveFilters.org uses and protects any information that you give FiveFilters.org when you use this website or the applications hosted here.</p>

				<p>FiveFilters.org is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement.</p>

				<p>FiveFilters.org may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective from 20 August 2011.</p>

				<h3>Information we may ask for</h3>

				<p>We try to collect as little information as possible. Most of what we ask for is the minimum we need to provide the services we do, and most of the information that is supplied is discarded as soon as it has served its purpose. Depending on the services you use on FiveFilters.org, we may ask for the following information:</p>

				<ul class="wordy-list">
					<li>URLs of web pages or feeds (stored temporarily on our servers to improve performance)</li>
					<li>Your Kindle email address and, optionally, an email address on your approved Amazon Kindle list (used for sending articles, but not stored on our servers after sending completes)</li>
					<li>Your API key if you register as a paying customer</li>
					<li>Your email address if you register as a paying customer or join our forums</li>
				</ul>

				<p>Occasionally we also enable logging on our servers for statistical analysis. When logging is enabled, IP addresses are stored. We destroy logs once they have served their purpose.</p>

				<h3>What we do with the information we gather</h3>

				<p>The information we collect is used to ensure optimal system performance and to improve the services we offer. We do not share this information except when necessary to carry out the requested task - for example, to deliver web articles to your Kindle using your Kindle email address, we have to communicate and share information with Amazon's servers.</p>

				<p>If logging is enabled, the information collected (such as IP addresses) is never shared with anyone else.</p>
				...
				<p>None of our services currently rely on cookies, but we do use cookies for paying customers to improve the experience of some of our services.</p>
				...
				<p>You can choose to accept or decline cookies. Most web browsers automatically accept cookies, but you can usually modify your browser setting to decline cookies if you prefer. You can still take full advantage of the website with cookies disabled.</p>
				...
				<p>If you believe that any information we are holding on you is incorrect or incomplete, please write to or email us as soon as possible at fivefilters (at) fivefilters.org. We will promptly correct any information found to be incorrect.</p>
			...
			<div class="span6" id="stay-up-to-date">
				...
				<ul class="rrssb-buttons clearfix" style="width: 90px; height: 35px;">
				  <li class="rrssb-email">
				    ...
				    <a href="mailto:?subject=Check%20out%20this%20page%20from%20FiveFilters.org&amp;body=https%3A%2F%2Ffivefilters.org%2Fprivacy.php" style="border-radius: 0;" title="Email">
				  ...
				  <li class="rrssb-facebook">
				    ...
				    <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ffivefilters.org%2Fprivacy.php" class="popup" style="border-radius: 0;" title="Share on Facebook">
				  ...
				  <li class="rrssb-twitter">
				    ...
				    <a href="https://twitter.com/intent/tweet?text=Check%20out%20this%20page%20from%20%40fivefilters%3A%20https%3A%2F%2Ffivefilters.org%2Fprivacy.php"
