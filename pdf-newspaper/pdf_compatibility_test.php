<?php
/*
PDF NEWSPAPER 2.3 COMPATIBILITY TEST

1) Upload pdf_compatibility_test.php to the web-accessible root of your website.
For example, if your website is www.example.com, upload it so that you can get
to it at www.example.com/pdf_compatibility_test.php
	...
	<div id="content">
		...
		<div class="chunk">
			<?php if ($php_ok && $xml_ok && $pcre_ok && $mbstring_ok && $iconv_ok && $filter_ok && $allow_url_fopen_ok) { ?>
				...
				<p>You can download the latest version of <?php echo $app_name; ?> from <a href="http://fivefilters.org/pdf-newspaper/#download">FiveFilters.org</a>.</p>
